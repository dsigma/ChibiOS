...
#error "TIMCAP driver activated but no TIM peripheral assigned"
    ...
    !CORTEX_IS_VALID_KERNEL_PRIORITY(STM32_TIMCAP_TIM1_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TIM1"
#endif

#if STM32_TIMCAP_USE_TIM2 &&                                                   \
    !CORTEX_IS_VALID_KERNEL_PRIORITY(STM32_TIMCAP_TIM2_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TIM2"
#endif

#if STM32_TIMCAP_USE_TIM3 &&                                                   \
    !CORTEX_IS_VALID_KERNEL_PRIORITY(STM32_TIMCAP_TIM3_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TIM3"
#endif

#if STM32_TIMCAP_USE_TIM4 &&                                                   \
    !CORTEX_IS_VALID_KERNEL_PRIORITY(STM32_TIMCAP_TIM4_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TIM4"
#endif

#if STM32_TIMCAP_USE_TIM5 &&                                                   \
    !CORTEX_IS_VALID_KERNEL_PRIORITY(STM32_TIMCAP_TIM5_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TIM5"
#endif

#if STM32_TIMCAP_USE_TIM8 &&                                                   \
    !CORTEX_IS_VALID_KERNEL_PRIORITY(STM32_TIMCAP_TIM8_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TIM8"
#endif

#if STM32_TIMCAP_USE_TIM9 &&                                                   \
    !CORTEX_IS_VALID_KERNEL_PRIORITY(STM32_TIMCAP_TIM9_IRQ_PRIORITY)
 ...
 */
typedef enum {
  TIMCAP_INPUT_ACTIVE_HIGH = 0,        /**< Trigger on rising edge.            */
  TIMCAP_INPUT_ACTIVE_LOW = 1,         /**< Trigger on falling edge.           */
} timcapmode_t;
...
typedef struct {
   ...
   * @brief   Driver mode.
   */
  timcapmode_t                 modes[TIMCAP_CHANNEL_4 + 1];
  /**
   ...
   */
  timcapcallback_t             capture_cb_array[TIMCAP_CHANNEL_4 + 1];
...
struct TIMCAPDriver {
   ...
   */
  volatile uint32_t         *ccr_p[TIMCAP_CHANNEL_4 + 1];
};
